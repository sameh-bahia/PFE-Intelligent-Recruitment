...
import { Briefcase, FileText, User, ArrowRight } from 'lucide-react';
  ...
  return (
    <MainLayout role="CANDIDAT" userName={userName}>
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Bienvenue, {userName}! Que souhaitez-vous faire aujourd'hui?</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Link
          to="/dashboard/candidat/offres"
          className="bg-white rounded-2xl shadow-sm p-8 hover:shadow-lg transition-all duration-300 border border-[#E2E8F0] group"
        >
          <div className="flex items-center gap-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 mt-1">Consultez les offres d'emploi disponibles</p>
            </div>
        ...
        >
          <div className="flex items-center gap-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 mt-1">Gérez vos candidatures en cours</p>
            </div>
        ...
        >
          <div className="flex items-center gap-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 mt-1">Gérez votre CV et vos informations</p>
            </div>
